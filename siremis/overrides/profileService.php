...
class profileService
{
    ...
    protected function InitDBProfile($username)
    {
        ...
        // Load contact profile — wrapped so a missing/broken contact table
        // never blocks login from completing.
        try {
            ...
            BizSystem::log(LOG_WARNING, "PROFILE", "Contact profile load skipped: " . $e->getMessage());
        }
